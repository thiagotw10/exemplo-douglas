...
<span>Cargos</span>
    ...
    <li>
        <a href="<?php echo base_url('Grupos'); ?>" <?= $controller == "Grupos" ? "class='active'" : "" ?>>
            <div class="imgIcon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clipboard-list" width="36" height="36" viewBox="0 0 24 24" stroke-width="1.5" stroke="#9e9e9e" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
